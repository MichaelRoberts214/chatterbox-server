...
//to all messages sent by the user
    server: 'http://127.0.0.1:3000/',//'https://api.parse.com/1/classes/chatterbox/', // http://127.0.0.1:3000/classes/messages
    username: 'anonymous',
    roomname: 'lobby',
    lastMessageId: 0,
    friends: {},
    ...
    fetch: function(animate) {
      $.ajax({
        ...
        success: function(data) {
          ...
          var mostRecentMessage = data.results[0]; // because first message is most recent
